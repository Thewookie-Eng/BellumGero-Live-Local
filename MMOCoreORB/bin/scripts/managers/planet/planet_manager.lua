...
dathomir = {
	...
	planetTravelPoints = {
		...
		{name = "Village", x = 5221, z = 78, y = -4069, interplanetaryTravelAllowed = 1, incomingTravelAllowed = 1, landingRange = 3}
	},
	...
	navAreas = {
		...
		{"wall",7442,-3024,32},
		{"aurillian_village",5240,-4069,150}
	},

	planetObjects = {
		{templateFile = "object/tangible/terminal/terminal_mission.iff", ox = 0, oy = 0.383, oz = 0, ow = 0.924, x = 5259.9, z = 78.5, y = -4224.0, parentid = 0},
		{templateFile = "object/building/naboo/shuttleport_naboo.iff", ox = 0, oy = 0, oz = 0, ow = 1, x = 5240, z = 78, y = -4069, parentid = 0}
	}
}
...
lok = {
	...
	planetTravelPoints = {
		...
		{name = "Imperial Outpost", x = -1914, z = 12, y = -3147, interplanetaryTravelAllowed = 1, incomingTravelAllowed = 1, landingRange = 3},
	},
	...
	--	{templateFile = "object/tangible/terminal/terminal_character_builder.iff", ox = 0, oy = 0.999879, oz = 0, ow = 0.015506, x = 464.677, z = 8.75806, y = 5506.49, parentid = 0}
		{templateFile = "object/building/tatooine/shuttleport_tatooine.iff", ox = 0, oy = 1, oz = 0, ow = 0, x = -1933, z = 12, y = -3146, parentid = 0}
}
}
