-- Droid Foundry general corpse loot for B2-family droids.
-- Premium subpool contains Combat Module, Armor Module, and B2 chassis only.
-- Total weight = 10,000,000.

droid_foundry_kill_loot_b2 = {
	description = "Droid Foundry on-kill loot - B2 family",
	minimumLevel = 0,
	maximumLevel = -1,
	lootItems = {
		...
		{groupTemplate = "droid_foundry_kill_components_b2", weight = 1400000},
		{groupTemplate = "droid_foundry_kill_furniture", weight = 500000},
	}
}

addLootGroupTemplate("droid_foundry_kill_loot_b2", droid_foundry_kill_loot_b2)
