...
object_draft_schematic_droid_component_chassis_droid_battle_droid_foundry = object_draft_schematic_droid_component_shared_chassis_droid_battle_droid_foundry:new {
	...
	targetTemplate = "object/tangible/component/droid/battle_droid_foundry_chassis.iff",
	additionalTemplates = {}
}

ObjectTemplates:addTemplate(object_draft_schematic_droid_component_chassis_droid_battle_droid_foundry, "object/draft_schematic/droid/component/chassis_droid_battle_droid_foundry.iff")
