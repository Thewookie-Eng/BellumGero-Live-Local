...
object_draft_schematic_clothing_clothing_armor_coruscant_clonetrooper_suit = object_draft_schematic_clothing_shared_clothing_armor_coruscant_clonetrooper_suit:new {
	...
	targetTemplate = "object/tangible/wearables/armor/clone_trooper/armor_coruscant_clonetrooper_suit_package.iff", additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_coruscant_clonetrooper_suit, "object/draft_schematic/clothing/clothing_armor_coruscant_clonetrooper_suit.iff")
