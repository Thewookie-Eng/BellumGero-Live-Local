...
object_draft_schematic_clothing_clothing_armor_stormtrooper_suit = object_draft_schematic_clothing_shared_clothing_armor_stormtrooper_suit:new {
	...
	targetTemplate = "object/tangible/wearables/armor/stormtrooper/armor_stormtrooper_suit_package.iff", additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_stormtrooper_suit, "object/draft_schematic/clothing/clothing_armor_stormtrooper_suit.iff")
