-- Bellum Gero Chitin Armor Full-Suit Crafting
-- Recipe totals are derived from the current individual suit schematics.

object_draft_schematic_clothing_clothing_armor_chitin_suit =
	object_draft_schematic_clothing_shared_clothing_armor_chitin_suit:new {
	templateType = DRAFTSCHEMATIC,
	customObjectName = "Chitin Armor Suit Package",
	craftingToolTab = 2,
	complexity = 25,
	size = 1,
	...
	targetTemplate = "object/tangible/wearables/armor/chitin/armor_chitin_suit_package.iff",
	additionalTemplates = {}
}

ObjectTemplates:addTemplate(
	object_draft_schematic_clothing_clothing_armor_chitin_suit,
	"object/draft_schematic/clothing/clothing_armor_chitin_suit.iff")
