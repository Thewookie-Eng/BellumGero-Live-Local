...
object_tangible_wearables_armor_bounty_hunter_shared_armor_bounty_hunter_suit_package =
	SharedTangibleObjectTemplate:new { clientTemplateFileName = "object/tangible/wearables/armor/bounty_hunter/shared_armor_bounty_hunter_suit_package_item.iff" }
ObjectTemplates:addClientTemplate(object_tangible_wearables_armor_bounty_hunter_shared_armor_bounty_hunter_suit_package, "object/tangible/wearables/armor/bounty_hunter/shared_armor_bounty_hunter_suit_package_item.iff")
