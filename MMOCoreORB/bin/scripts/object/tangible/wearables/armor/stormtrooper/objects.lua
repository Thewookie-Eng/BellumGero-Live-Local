...
object_tangible_wearables_armor_stormtrooper_shared_armor_stormtrooper_suit_package =
	SharedTangibleObjectTemplate:new { clientTemplateFileName = "object/tangible/wearables/armor/stormtrooper/shared_armor_stormtrooper_suit_package_item.iff" }
ObjectTemplates:addClientTemplate(object_tangible_wearables_armor_stormtrooper_shared_armor_stormtrooper_suit_package, "object/tangible/wearables/armor/stormtrooper/shared_armor_stormtrooper_suit_package_item.iff")
