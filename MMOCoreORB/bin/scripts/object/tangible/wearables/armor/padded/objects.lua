...
object_tangible_wearables_armor_padded_shared_armor_padded_suit_package =
	SharedTangibleObjectTemplate:new {
	clientTemplateFileName = "object/tangible/wearables/armor/padded/shared_armor_padded_suit_package_item.iff"
}

ObjectTemplates:addClientTemplate(
	object_tangible_wearables_armor_padded_shared_armor_padded_suit_package,
	"object/tangible/wearables/armor/padded/shared_armor_padded_suit_package_item.iff")
