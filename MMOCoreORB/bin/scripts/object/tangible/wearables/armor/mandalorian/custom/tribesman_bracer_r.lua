...
object_tangible_wearables_armor_mandalorian_custom_tribesman_bracer_r = object_tangible_wearables_armor_mandalorian_shared_armor_mandalorian_bracer_r:new {
	...
	customName = "Mandalorian Tribesman Bracer (Right)",
...
ObjectTemplates:addTemplate(object_tangible_wearables_armor_mandalorian_custom_tribesman_bracer_r, "object/tangible/wearables/armor/mandalorian/custom/tribesman_bracer_r.iff")
