...
ObjectTemplates:addTemplate(object_tangible_wearables_armor_mandalorian_custom_verdika_legs, "object/tangible/wearables/armor/mandalorian/custom/verdika_legs.iff")
