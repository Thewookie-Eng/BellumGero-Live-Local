...
object_tangible_wearables_armor_mandalorian_custom_tribesman_bicep_r = object_tangible_wearables_armor_mandalorian_shared_armor_mandalorian_bicep_r:new {
	...
	customName = "Mandalorian Tribesman Bicep (Right)",
...
ObjectTemplates:addTemplate(object_tangible_wearables_armor_mandalorian_custom_tribesman_bicep_r, "object/tangible/wearables/armor/mandalorian/custom/tribesman_bicep_r.iff")
