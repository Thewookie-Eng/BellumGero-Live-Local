...
object_tangible_wearables_armor_mandalorian_custom_hunter_helmet = object_tangible_wearables_armor_mandalorian_shared_armor_mandalorian_helmet:new {
...
ObjectTemplates:addTemplate(object_tangible_wearables_armor_mandalorian_custom_hunter_helmet, "object/tangible/wearables/armor/mandalorian/custom/hunter_helmet.iff")
