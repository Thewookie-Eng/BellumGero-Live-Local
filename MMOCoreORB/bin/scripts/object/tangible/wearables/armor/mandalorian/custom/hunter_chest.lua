...
object_tangible_wearables_armor_mandalorian_custom_hunter_chest = object_tangible_wearables_armor_mandalorian_shared_armor_mandalorian_chest_plate:new {
	...
	customName = "Hunter's Chest Plate",
...
ObjectTemplates:addTemplate(object_tangible_wearables_armor_mandalorian_custom_hunter_chest, "object/tangible/wearables/armor/mandalorian/custom/hunter_chest.iff")
