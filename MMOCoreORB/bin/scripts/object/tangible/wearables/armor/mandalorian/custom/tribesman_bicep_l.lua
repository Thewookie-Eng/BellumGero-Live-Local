...
object_tangible_wearables_armor_mandalorian_custom_tribesman_bicep_l = object_tangible_wearables_armor_mandalorian_shared_armor_mandalorian_bicep_l:new {
	...
	customName = "Mandalorian Tribesman Bicep (Left)",
...
ObjectTemplates:addTemplate(object_tangible_wearables_armor_mandalorian_custom_tribesman_bicep_l, "object/tangible/wearables/armor/mandalorian/custom/tribesman_bicep_l.iff")
