...
object_tangible_wearables_armor_mandalorian_custom_tribesman_shoes = object_tangible_wearables_armor_mandalorian_shared_armor_mandalorian_shoes:new {
	...
	customName = "Mandalorian Tribesman Boots",
...
ObjectTemplates:addTemplate(object_tangible_wearables_armor_mandalorian_custom_tribesman_shoes, "object/tangible/wearables/armor/mandalorian/custom/tribesman_shoes.iff")
