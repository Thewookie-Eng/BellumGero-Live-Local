-- Mandalorian Way of Life — Chapter 4 (Clanbound) reward, part 4 of 6; LIGHT slot stats aligned (58% + blast 65), 10 stun/saber, no vulnerability bitmask

object_tangible_wearables_armor_mandalorian_custom_clanbound_bracer_l = object_tangible_wearables_armor_mandalorian_shared_armor_mandalorian_bracer_l:new {
	...
	customName = "Clanbound Bracer (Left)",
