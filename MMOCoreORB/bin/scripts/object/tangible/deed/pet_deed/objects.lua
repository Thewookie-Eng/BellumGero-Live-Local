...
object_tangible_deed_pet_deed_shared_doctor_buff_droid = SharedTangibleObjectTemplate:new {
	clientTemplateFileName = "object/tangible/deed/pet_deed/shared_doctor_buff_droid.iff"
}
