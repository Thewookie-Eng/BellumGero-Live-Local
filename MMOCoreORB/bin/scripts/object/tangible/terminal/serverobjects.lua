...
includeFile("tangible/terminal/terminal_droid_foundry_nexus.lua")
...
includeFile("tangible/terminal/geneticists_failed_experiment_terminal.lua")
includeFile("tangible/terminal/galaxy_combat_board_terminal.lua")
