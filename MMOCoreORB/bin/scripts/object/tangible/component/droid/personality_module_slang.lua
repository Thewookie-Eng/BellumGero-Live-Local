...
object_tangible_component_droid_personality_module_slang = object_tangible_component_droid_shared_personality_module_slang:new {
	...
	personalityStf = "@hireling/hireling_droid_slang",
	conversationTemplate = "pet_slang_convotemplate",

	numberExperimentalProperties = {1, 1, 1, 1},
	experimentalProperties = {"XX", "XX", "XX", "XX"},
	experimentalWeights = {1, 1, 1, 1},
	experimentalGroupTitles = {"null", "null", "null", "null"},
	experimentalSubGroupTitles = {"null", "null", "hitpoints", "personality_module"},
	experimentalMin = {0, 0, 1000, 25},
	experimentalMax = {0, 0, 1000, 25},
