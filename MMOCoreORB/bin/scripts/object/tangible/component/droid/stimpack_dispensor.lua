...
object_tangible_component_droid_stimpack_dispensor = object_tangible_component_droid_shared_stimpack_dispensor:new {
	...
	experimentalProperties = {"XX", "XX", "XX", "CD", "OQ", "CD", "OQ"},
	experimentalWeights = {1, 1, 1, 1, 1, 1, 1},
	experimentalGroupTitles = {"null", "null", "null", "exp_durability", "exp_effectiveness"},
	experimentalSubGroupTitles = {"null", "null", "hitpoints", "stimpack_capacity", "stimpack_speed"},
	experimentalMin = {0, 0, 1000, 1, 1},
	experimentalMax = {0, 0, 1000, 100, 10},
	experimentalPrecision = {0, 0, 0, 0, 1},
