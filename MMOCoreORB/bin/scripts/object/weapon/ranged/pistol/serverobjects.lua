...
includeFile("weapon/ranged/pistol/pistol_foundling_cdef_beskar.lua")
...
includeFile("weapon/ranged/pistol/pistol_bellum_bowcaster_stats.lua")
...
includeFile("weapon/ranged/pistol/pistol_mando_way_geo_blaster.lua")
includeFile("weapon/ranged/pistol/pistol_mando_way_geo_blaster_dev.lua")
...
includeFile("weapon/ranged/pistol/pistol_blackfalcon.lua")