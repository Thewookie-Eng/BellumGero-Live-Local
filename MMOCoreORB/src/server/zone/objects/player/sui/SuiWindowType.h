...
public:
	enum {
		...
		FACTORY_QUEUE_BATCH_AMOUNT         = 94,
		FACTORY_QUEUE_BATCH_CONFIRM        = 95,
		FACTORY_QUEUE_LOAD_INGREDIENTS     = 96,
		FACTORY_QUEUE_HOPPER_MANAGER       = 97,
		FACTORY_QUEUE_BATCH_EDIT_AMOUNT    = 98,
		FACTORY_QUEUE_BATCH_EDIT_CONFIRM   = 99,
		...
		STRUCTURE_ARCHITECT_RETROFIT       = 159,
		STRUCTURE_REMOTE_MAINTENANCE_LIST  = 160,
		STRUCTURE_REMOTE_MAINTENANCE_PAY   = 161,
		STRUCTURE_REMOTE_POWER_LIST        = 162,
		STRUCTURE_REMOTE_POWER_DEPOSIT     = 163,
		STRUCTURE_REMOTE_MANAGEMENT_LIST   = 164,
		STRUCTURE_REMOTE_MANAGEMENT_PAY    = 165,
		STRUCTURE_REMOTE_MANAGEMENT_POWER  = 166,
		...
		BIO_ENGINEER_CRAFT_CATEGORY			= 1045,
		BIO_ENGINEER_CRAFT_CREATURE			= 1046,
		VENDOR_GUILD_DISCOUNTS				= 1047,
		VENDOR_GUILD_DISCOUNT_GUILD			= 1048,
		VENDOR_GUILD_DISCOUNT_SELECT		= 1049,
		VENDOR_GUILD_DISCOUNT_PERCENT		= 1050,
		VENDOR_GUILD_DISCOUNT_CONFIRM		= 1051,
		VENDOR_GUILD_DISCOUNT_REMOVE_CONFIRM = 1052,

		//JTL
		SHIP_TEXTURE_SELECT					= 1100,
		REVERSE_ENGINEER					= 1101,
		DROID_CHIP_PROGRAMMING					= 1102,
		RECRUIT_FACTION_TROOPS					= 1103,
		MISSION_TERMINAL_DISTANCE_SELECT		= 1104,

		// BG: Bellum Gero display mannequin
		MANNEQUIN_EQUIP						= 1200,
		MANNEQUIN_EQUIP_WEAPON				= 1201,
		MANNEQUIN_REMOVE					= 1202,
		MANNEQUIN_RENAME					= 1203,
		MANNEQUIN_POSE						= 1204,
		MANNEQUIN_CREATE					= 1205,
	};
};
